...
public class StudentInfoPageChange extends HttpServlet {
	...
	private static final long serialVersionUID = 1L;
	 ...
	 @Override
	    public void doPost(HttpServletRequest request,HttpServletResponse response)throws IOException,ServletException{
		 ...
		 //得到换页之后的内容
		 List<String[]> studentInfoList=DbUtil.getPageContent(pages.getCurPage(),sqlString);
		 request.setAttribute("studentInfoList",studentInfoList);
		 session.setAttribute("pages", pages);
		 //forward到修改的主页面
		 String urlString="/getAllStudentMess.jsp";
