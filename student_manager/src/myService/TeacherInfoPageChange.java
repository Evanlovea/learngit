...
public class TeacherInfoPageChange extends HttpServlet {
	...
	private static final long serialVersionUID = 1L;
	 ...
	 @Override
	    public void doPost(HttpServletRequest request,HttpServletResponse response)throws IOException,ServletException{
		 ...
		 //得到换页之后的内容
		 List<String[]> teacherInfoList=DbUtil.getPageContent(pages.getCurPage(),sqlString);
		 request.setAttribute("teacherInfoList", teacherInfoList);
		 session.setAttribute("pages", pages);
		 //forward到修改的主页面
		 String urlString="/getAllTeacherMess.jsp";
